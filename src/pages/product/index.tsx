      ...
      <Grid item xs={12} sm={12} md={12} lg={12}>
        <Grid container>
          <Grid item xs={12} sm={12} md={12} lg={6}>
            <Typography variant="caption" title="PICK UP YOUR" className="label">PICK UP YOUR</Typography>
            <Typography variant="h4" className="heading" title="Maxican Street Toca Plate">Maxican Street Toca Plate</Typography>
            <Typography variant="h6" title="Lorem ipsum dolor sit amet, consectetur adipiscing elit.">
            ...
            <Grid container>
              <Grid item xs={6}>
                <Typography variant="caption" className="label bold" title="1000 Cal">1000 Cal</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography variant="h6" className="price" title="$9.69">$9.69</Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={12} sm={12} md={12} lg={6}>
            ...
            <Card elevation={6} className="single-product">
              <Grid container>
                ...
                <CardContent sx={{ flex: '1 0 auto' }}>
                  <Typography title="TACO ONE" variant="caption" className="label">TACO ONE</Typography>
                  <Typography variant="h4" title="MAXICAN STREET CORN SHRIMP TACO">MAXICAN STREET CORN<br/> SHRIMP TACO</Typography>
                  <Button title="Click to customize" className="custom-btn" endIcon={<ArrowForward />}>CLICK TO CUSTOMIZE</Button>
                </CardContent>
              </Grid>
            </Card>
          </Grid>
        ...
        <Grid container className="menu-items">
          <Typography variant="h4" title="SELECT SIDE ONE">SELECT SIDE ONE</Typography>
          <FoodMenuCard menuItems={menuItems1} />
          <Typography variant="h4" title="SELECT SIDE TWO">SELECT SIDE TWO</Typography>
          <FoodMenuCard menuItems={menuItems2} />
          <Typography variant="h4" title="ADD A DRINK">ADD A DRINK</Typography>
