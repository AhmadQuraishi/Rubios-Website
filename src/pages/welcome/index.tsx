    ...
    return (
        <>
            <Grid container component="main" columns={16} className={classes.root}>
                <Grid item xs={12} sm={12} md={12} lg={10} style={{ marginTop: '20px' }}>
                    <Card>
                        <Grid container style={{ justifyContent: 'center', marginTop: '20px' }}>
                            <Grid item xs={12} sm={12} md={12} lg={6}>
                                ...
                                <Card elevation={0} style={{ border: '1px solid black' }}>
                                    <Grid container>
                                        ...
                                        <Grid item lg={10} sm={12} md={12} xs={12} style={{marginLeft: "60px"}}>
                                            <CardContent>
                                                ...
                                                <Typography aria-label='edit order' variant="button" color='text.secondary'> EDIT ORDER </Typography> <Typography variant="button" color='blue'> ORDER </Typography>
                                            </CardContent>
                                        </Grid>
                                    </Grid>
                                </Card>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={7} style={{ marginLeft: '10px' }}>
                                ...
                                <CustomButton aria-label="pickup button" variant="contained" text="PICKUP" /><br />
                                <CustomButton aria-label="curbside button" variant="contained" text="CURBSIDE" /><br />
                                <CustomButton aria-label="delivery button" variant="contained" text="DELIVERY" /><br />
                            </Grid>
                        </Grid>
                    </Card>
                </Grid>
