...
const Login = () => {
  ...
  let login = () => {
    const windowHandle = window.open(
      `https://sandbox.punchh.com/oauth/authorize?client_id=${PUNCHH_CLIENT_ID}&force_logout=true&redirect_uri=${encodeURIComponent(window.location.href)}&response_type=code&sso=true`,
      "Rubios Login",
