import { BillingMethodEnum, UserTypeEnum, CountryEnum, CardTypeEnum, SaveOnFileEnum } from './olo-api.enums'
...
interface RequestBasketSubmit {
    ...
    receivinguser?: {    //Specify a separate customer that will receive the order.
