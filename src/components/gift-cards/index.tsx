...
const GiftCards = ({ billingAccounts, loading }: any) => {
  ...
  return (
    <Grid container>
      ...
      <Grid item xs={12}>
        <br/>
        <Typography variant="h6"  sx={{fontFamily: "'Librefranklin-Light' !important"}} title="To add a gift card to your account, place an order and enter the gift card information during checkout.">
