...
const PaymentInfo = forwardRef((props: any, _ref) => {
  ...
  const { ccsfObj, basketAccessToken,moveFocusBackToScreen, handleCreditCardSubmit, displayAddCreditCard, hideShow, setHideShow, zipCode, setZipCode, cardExpiry, setCardExpiry } = props;
