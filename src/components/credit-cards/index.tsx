  ...
  return (
    <Grid container>
      <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          <br/>
          <Typography variant="h6" sx={{  fontFamily: "'Libre Franklin' !important"}} title="To add a credit card to your account, place an order and enter the credit card information during checkout.">
